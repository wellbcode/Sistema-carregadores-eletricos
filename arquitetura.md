...
* Não havendo fila, a estação permanece livre.
          ...
          ┌───────────┼────────────┐
          ▼           ▼            ▼
       ESTAÇÃO       PRISMA      INTERFACE
          │           │            │
          ▼           ▼            ▼
      verifica      procura      card →
      outros        outros      LIVRE 🔵
      usuários      usuários
          │           │            │
          ▼           ▼            ▼
     ainda existe   ainda existe   modal /
     alguém         alguém         formulário
     usando?        usando?        │
       /  \           /  \         ▼
     SIM   NÃO      SIM   NÃO     reset
      │     │        │     │
      │     ▼        │     ▼
      │   LIBERA     │   LIBERA
      │   ESTAÇÃO    │   PRISMA
...
Estação #001 → Prisma 00 → Concluído
Estação #002 → Prisma 00 → Carregando
Estação #003 → Prisma 01 → Carregando

Depois de concluir a #001:

Estação #001 → LIVRE 🔵
Prisma 00    → 00 ⚡   ← porque #002 ainda usa
Estação #002 → EM USO 🟢
Estação #003 → EM USO 🟢

Depois de concluir a #002:

Estação #001 → LIVRE 🔵
Estação #002 → LIVRE 🔵
Prisma 00    → 00      ← ninguém mais usa
Estação #003 → EM USO 🟢
Prisma 01    → 01 ⚡
---
